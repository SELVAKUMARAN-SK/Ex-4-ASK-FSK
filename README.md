...
plt.suptitle(
    'NAME : \nREG NO SELVAKUMARAN J: 212224060242',
    fontsize=12,
    fontweight='bold'
)
...
for i, b in enumerate(bits):
    fsk[i * bd:(i + 1) * bd] = np.sin(
        2 * np.pi * (f2 if b else f1) * t[i * bd:(i + 1) * bd]
    )
...
## OUTPUT WAVEFORM:
#### ASK:
<img width="779" height="704" alt="Screenshot 2026-05-18 104902" src="https://github.com/user-attachments/assets/4ff18f80-2323-47fc-a204-3656389f0b6c" />



#### FSK:
<img width="780" height="771" alt="Screenshot 2026-05-18 105408" src="https://github.com/user-attachments/assets/1b0410d5-a37f-43c9-93fe-f11a2bb8f1d7" />
